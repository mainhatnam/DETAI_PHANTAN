...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 08, 2022 lúc 09:20 PM
...
INSERT INTO `nhanvien` (`MANV`, `TENNV`, `SDTNV`, `GIOITINH`, `NGAYVAOLAM`, `MASHOP`) VALUES
(1, 'Ngo Quoc Thang', '091765543', 1, '2022-02-05', 1),
(2, 'Mai Nhat Nam', '091765544', 1, '2022-02-02', 1),
(3, 'Nguyen Thanh Tuan', '091765545', 1, '2022-02-02', 2),
(4, 'Nguyen Thanh Tu', '091765546', 1, '2022-02-01', 2);
...
ALTER TABLE `hoadon`
  ...
  ADD CONSTRAINT `hoadon_ibfk_2` FOREIGN KEY (`MASHOP`) REFERENCES `shop` (`MASHOP`),
...
--
ALTER TABLE `nhanvien`
  ADD CONSTRAINT `nhanvien_ibfk_1` FOREIGN KEY (`MASHOP`) REFERENCES `shop` (`MASHOP`);
